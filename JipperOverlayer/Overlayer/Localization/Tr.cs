...
public static class Tr
{
    public enum Key
    {
        ...
        ExtendedOverlayMode, ShowFps, ShowAuthor, ShowState,
        ShowDeath, ShowStart, ShowTiming,
        HideDebugText, RemoveAutoReq, CheckPseudo, AllowELCombo, AllowOrangeCombo, ComboTitleAltOnNonPerfect,
        LangLabel,
    ...
    [
        /* 0  English */ [ "Size", "Show Progress", "Show Accuracy", "Show XAccuracy",
            ...
            "Extended Overlay", "Show FPS", "Show Author", "Show State",
            "Show Death", "Show Start", "Show Timing",
            "Hide Debug Text", "Remove Not Required In Auto", "Check Pseudo", "EL Judgment Combo", "VL Judgment Combo", "Combo Title Alt On Non-Perfect Hit",
            "Language",
        ...
        /* 1  Korean */ [ "크기", "진행도 표시", "정확도 표시", "X정확도 표시",
            ...
            "사망 표시", "시작 표시", "타이밍 표시",
            "디버그 텍스트 숨기기", "자동에서 불필요한 것 제거", "의사 BPM 확인", "EL 판정 콤보", "VL 판정 콤보", "비퍼펙트 시 콤보 타이틀 변경",
            "언어",
            "글꼴", "사용자 지정 위치", "위치 초기화",
        ...
        /* 2  Chinese */ [ "大小", "显示进度", "显示准确率", "显示X准确率",
            ...
            "ExtendedOverlay模式", "显示FPS", "显示作者", "显示状态",
            "显示死亡", "显示开始", "显示时机",
            "隐藏调试文本", "自动模式简化显示", "检测伪BPM", "允许EL判定连击", "允许VL判定连击", "非完美命中时切换连击标题",
            "语言",
            "字体", "自定义位置", "重置位置",
